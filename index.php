...
<body>
    <h1>Bienvenue sur le Jeu de Songo</h1>
    <h3>Réalisé par : ONANA GREGOIRE LEGRAND (Matricule: 24G2060)</h3>
    <p>Veuillez choisir la version à tester :</p>
    
    <div class="menu">
        <a href="v1_local/index.html" class="btn">Jouer à la Version 1 (Local)</a>
        <a href="v2_remote/index.php" class="btn">Jouer à la Version 2 (Multi-joueur AJAX)</a>
    </div>
</body>
</html>
